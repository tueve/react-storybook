...
Promise.all([
  ...
  .then(() => {
    ...
    exec(
      `${rollupPath} -c scripts/rollup.config.js -o umd/storybook-components-react.js`,
      {
        NODE_ENV: 'development',
      }
    );
    exec(
      `${rollupPath} -c scripts/rollup.config.js -o umd/storybook-components-react.min.js`,
      {
        NODE_ENV: 'production',
      }
    );
